...
func (ec *executionContext) marshalNUser2githubᚗcomᚋdomᚑm17ᚋlmsᚋbackendᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
