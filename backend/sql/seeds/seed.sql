...
-- Insert Users
INSERT INTO users (username, hashed_password, first_name, last_name, email, phone_number, date_of_birth, favourite_team)
VALUES
('jdoe', 'hashed_pw_123', 'John', 'Doe', 'jdoe@example.com', '07123456789', '1990-01-01', 1),
('asmith', 'hashed_pw_456', 'Alice', 'Smith', 'asmith@example.com', '07234567890', '1992-02-02', 2);
...
-- Insert Matches
INSERT INTO matches (id, home_team, away_team, matchday, match_date, home_goals, away_goals, has_finished)
VALUES
